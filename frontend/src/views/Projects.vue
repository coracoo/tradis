...
<script setup>
// 修改导入语句，添加 nextTick
import { ref, onMounted, shallowRef, nextTick, onBeforeUnmount, computed } from 'vue'
import { formatTimeTwoLines } from '../utils/format'
import { useRouter } from 'vue-router'
import { ElMessage, ElMessageBox } from 'element-plus'
import { Plus, Refresh, InfoFilled, ArrowDown, VideoPlay, VideoPause, Edit, Delete } from '@element-plus/icons-vue'
